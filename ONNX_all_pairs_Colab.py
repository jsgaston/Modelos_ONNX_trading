...
!pip install -q tensorflow pandas numpy scikit-learn tf2onnx
...
# Ruta del archivo CSV en la carpeta principal de Drive
CSV_PATH = '/content/drive/MyDrive/USDCAD_H1.csv'

# Lista de símbolos a procesar
symbols = ["USDCAD"]  # Puedes agregar más símbolos si tienes más CSVs
...
def train_and_save_model(symbol, csv_path, end_date=None, model_suffix=""):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"✗ Error al guardar modelo: {result.stderr}")
            return False
...
if not os.path.exists(CSV_PATH):
    ...
    print("Por favor, ajusta la variable CSV_PATH con la ruta correcta.")
else:
