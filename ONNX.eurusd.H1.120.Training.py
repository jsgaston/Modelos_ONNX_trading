...
# save model to ONNX with explicit input signature
input_signature = [tf.TensorSpec([None, inp_history_size, 1], tf.float32, name='input')]

output_path = data_path + inp_model_name
onnx_model, _ = tf2onnx.convert.from_keras(model, input_signature=input_signature, output_path=output_path)
